...
import * as blogStore from "../stores/blogStore";
import * as currentUserStore from "../stores/currentUserStore";
...
describe("<Blog />", () => {
  ...
  test("shows loading when blogs are not yet initialized/fetched", () => {
    ...
    vi.spyOn(blogStore, "useBlogs").mockReturnValue([]);
  ...
  describe("when authenticated", () => {
    ...
    test("clicking the like button twice calls event handler twice", async () => {
      ...
      vi.spyOn(blogStore, "useBlogActions").mockReturnValue({
        likeBlog: mockOnLike,
      });
